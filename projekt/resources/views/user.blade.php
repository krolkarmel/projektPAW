			...
			<div id="wrapper">
							...
							<section id="second" class="main special">
								...
								<ul class="statistics">
									...
									<li class="style3">
										...
										<strong>2,048</strong> Pozytywnych opinii
									</li>
									<!-- <li class="style5">
				...
				<!-- Footer -->
					<footer id="footer">
						<section>
							<h2>TommyKsiażka</h2>
							<p>Od lat zapewniamy Państwu dostęp do najlepszych i najbardziej pożądanych książek.<ul class="actions">
								<li><a href="generic.html" class="button">Learn More</a></li>
							</ul>
						</section>
						<section>
